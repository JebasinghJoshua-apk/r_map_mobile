  ...
  Future<void> _openFilters(Rect panelAnchorRect, Rect arrowAnchorRect) async {
    ...
    final result = await showGeneralDialog<_HomeMapFiltersDialogResult>(
      ...
      pageBuilder: (context, _, __) {
        ...
        final geometry = AnchoredPopoverGeometry.computeFullWidth(
          media: media,
          popupAnchorRect: panelAnchorRect,
            ...
            return Material(
              ...
              child: Stack(
                children: [
                                      ...
                                      onPressed: () {
                                        Navigator.of(context).pop(
                                          (
                                            ...
                                            apartmentCarParking:
                                                localApartmentCarParking,
                                            apartmentFloor: localApartmentFloor,
                  ...
                  Positioned(
                    top:
                        geometry.popupTop - arrowHeight + arrowOverlapIntoPopup,
